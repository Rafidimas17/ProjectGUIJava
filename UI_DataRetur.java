 ...
 * @author Asus
 */
public class UI_DataRetur extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblRetur.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        ...
        tblRetur.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tblRetur);
        tblRetur.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTambahMouseClicked
        UI_FormRetur fk=new UI_FormRetur();
        fk.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_DataRetur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
