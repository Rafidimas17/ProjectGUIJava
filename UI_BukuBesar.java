 ...
 * @author Asus
 */
public class UI_BukuBesar extends javax.swing.JFrame {
...
//                tblBarangMasuk.setModel(dtm);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_BukuBesar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
