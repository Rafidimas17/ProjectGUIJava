...
public class UI_DataPersediaan extends javax.swing.JFrame {
    ...
    public void table(){
        ...
        try{
            ...
            ResultSet rs_account=st.executeQuery("SELECT * FROM tbl_account");
            while(rs.next()){
                dtm.addRow(new Object[]{
                   rs_account.getString("kodeakun"),
    ...
    private void initComponents() {
        ...
        tblPersediaan.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        ...
        tblPersediaan.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tblPersediaan);
        tblPersediaan.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTambahMouseClicked
        UI_FormPersediaan fk=new UI_FormPersediaan();
        fk.setVisible(true);
        this.dispose();
