 ...
 * @author Asus
 */
public class UI_JurnalPembelian extends javax.swing.JFrame {

    /**
     * Creates new form UI_DataPembelian
     */
    public UI_JurnalPembelian() {
        initComponents();
        table();
    }
    public void table(){
        ...
        dtm.addColumn("Kode Akun");
        dtm.addColumn("nama Akun");
        dtm.addColumn("Debit");
...
//                tblPembelian.setModel(dtm);
    ...
    private void initComponents() {
        ...
        jLabel13.setText("JURNAL PEMBELIAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_JurnalPembelian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
