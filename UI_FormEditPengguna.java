 ...
 * @author Asus
 */
public class UI_FormEditPengguna extends javax.swing.JFrame {

    /**
     * Creates new form UI_FormPengguna
     */
    public UI_FormEditPengguna() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Ubah.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        Ubah.setText("Simpan");
        ...
        jLabel6.setText("FORM EDIT PENGGUNA");
    ...
    private void UbahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UbahMouseClicked
        ...
        try{
            String sql="UPDATE tbl_pengguna SET id_pengguna='"+textID.getText()+
                    "',username='"+tUser.getText()+
                    "',nama_lengkap='"+tNama.getText()+
                    "',hak_akses='"+(String) cmbHak.getSelectedItem()+
                    "',password='"+tPassword.getText()+
                    "',status='"+datard+"' WHERE id_pengguna='"+textID.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_FormEditPengguna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_FormEditPengguna().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JComboBox<String> cmbHak;
