...
public class UI_FormEditKategori extends javax.swing.JFrame {

    /**
     * Creates new form UI_FormKategori
     */
    public UI_FormEditKategori() {
        initComponents();
    }
    ...
    private void btnUpdateSupplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateSupplierMouseClicked
        ...
        try{
         String sql="UPDATE tbl_kategori SET idKategori='"+textIdKategori.getText()
                   +"',KategoriBarang='"+textKategoriBarang.getText()+"' WHERE idKategori='"+textIdKategori.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_FormEditKategori.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_FormEditKategori().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField textIdKategori;
    public javax.swing.JTextField textKategoriBarang;
