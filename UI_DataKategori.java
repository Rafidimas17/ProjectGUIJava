...
public class UI_DataKategori extends javax.swing.JFrame {
    ...
    private void btnUbahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUbahMouseClicked
        UI_FormEditKategori edit=new UI_FormEditKategori();
      int baris=Tbl_Kategori.getSelectedRow();
        TableModel tm=Tbl_Kategori.getModel();
        String idKategori = Tbl_Kategori.getValueAt(baris,0).toString();
//        System.out.println(nim);
        edit.textIdKategori.setText(idKategori);
        String KategoriBarang = Tbl_Kategori.getValueAt(baris,1).toString();
        edit.textKategoriBarang.setText(KategoriBarang);
