 ...
 * @author Asus
 */
public class UI_DataBarangMasuk extends javax.swing.JFrame {

    /**
     * Creates new form UI_DataBarangMasuk
     */
    public UI_DataBarangMasuk() {
        initComponents();
        table();
    }
    public void table(){
    ...
    private void initComponents() {
        ...
        tblBarangMasuk.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        ...
        tblBarangMasuk.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tblBarangMasuk);
        tblBarangMasuk.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        UI_FormBarangMasuk fk=new UI_FormBarangMasuk();
        fk.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_DataBarangMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
