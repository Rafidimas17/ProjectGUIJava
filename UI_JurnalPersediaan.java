 ...
 * @author Asus
 */
public class UI_JurnalPersediaan extends javax.swing.JFrame {

    /**
     * Creates new form UI_DataPembelian
     */
    public UI_JurnalPersediaan() {
        initComponents();
        table();
    }
    public void table(){
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("SELECT tbl_persediaanfix.*, tbl_barang.* FROM tbl_persediaanfix, tbl_barang WHERE tbl_persediaanfix.id_barang=tbl_barang.id_barang");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        txtSupplier1.setText("Atur Tanggal");

        tblPembelian.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        tblPembelian.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Barang", "Nama Barang", "Satuan", "Harga", "Kategori", "Supplier", "Stok", "Sub Total"
            }
        ) {
            Class[] types = new Class [] {
        ...
        tblPembelian.setColumnSelectionAllowed(true);
        jScrollPane2.setViewportView(tblPembelian);
        tblPembelian.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        ...
        jLabel13.setText("JURNAL PERSEDIAAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_JurnalPersediaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
